      ...
      <div class="bbbbb">
        ...
        ></v-progress-linear>
          ...
          <v-row>
              ...
              <v-col class="r"> <v-icon v-if="$store.getters.university_hour>$store.getters.stand_university_hour">mdi-check</v-icon></v-col>
              <v-col class="r"> <v-icon v-if="$store.getters.university_hour<$store.getters.stand_university_hour">mdi-window-close</v-icon></v-col>
          </v-row>
          <v-row>
          ...
          <v-row>
              ...
              <v-col class="r"> 
                ...
                <v-row>
                    ...
                    <v-col class="r">{{$store.getters.technical_act}}</v-col>
                    
                </v-row>
                <v-row>
                    <v-col >กิจกรรมกีฬาและนันทนาการ</v-col>
                    <v-col class="r">{{$store.getters.sport_act}}</v-col>
                </v-row>
                <v-row>
                    <v-col >กิจกรรมบำเพ็ญประโยชน์ หรือรักษาสิ่งแวดล้อม</v-col>
                    <v-col class="r">{{$store.getters.perform_act}}</v-col>
                </v-row>
                <v-row>
                    <v-col >กิจกรรมเสริมสร้างคุณธรรม จริยธรรม</v-col>
                    <v-col class="r">{{$store.getters.moral_act}}</v-col>
                </v-row>
                <v-row>
                    <v-col >กิจกรรมอนุรักษ์ศิลปวัฒนธรรม</v-col>
                    <v-col class="r">{{$store.getters.cultural_act}}</v-col>
                </v-row>
